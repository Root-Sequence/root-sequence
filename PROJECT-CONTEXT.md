...
project_id: root-sequence
repository: Root-Sequence/root-sequence
visibility: public
status: active-living
---

# Project Context — Root Sequence
...
- Update navigation when a structural change would otherwise become hard to find.
- Never expose private-project substance through a public cross-reference.

## Update contract

Review this file when repository scope, top-level structure, canonical maps, active public status, or major ecosystem relationships change. Fine-grained research belongs in its canonical document, not here.
