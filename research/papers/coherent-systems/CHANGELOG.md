...
`5c15f7fecd96924b9a18f6ff49d2cb01f2568dd0` onto the reorganized repository's
current `main` history. Repaired the Legible Systems references to use the
canonical `concepts/legible-systems.md` path and added current navigation from
the research index, repository front door, repository map, and Idea Trails.

The earlier additions to Thought Routing, Legible Systems, and the historical
UCF overview were reconciled with their current canonical files instead of
restoring the retired `core/` structure. No manuscript claim, source-reading
record, author decision, byline, paper version, test status, or publication
