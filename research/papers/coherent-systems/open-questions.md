...
Have reviewers separately describe the observable action and restriction; the claimed harm, claimant, evidence, and uncertainty; target performance; boundary omissions; affected relationships and power; and the later normative or procedural assessment. Then apply C-003. Record ambiguity, excluded parties, disagreements, the mechanism of any proposed false coherence, and whether the vocabulary adds clarity. Do not treat target execution as coherence, assume that “protection” settles what counts as harm, or let a compound label decide the justification in advance.
