...
Coercion describes a means—overriding meaningful choice through force, restraint, threats, confinement, or penalties—not a complete judgment of whether an intervention is justified. Stopping immediate harm can itself be coercive. The claim of harm is also situated: it cannot be made wholly perspective-free, but neither should one actor's private or unchallengeable definition settle it. A protective justification should specify the alleged harm, evidence, affected parties, severity, immediacy, uncertainty, and alternatives. The intervention should face stronger justification as its force, duration, irreversibility, or consequences increase, with scoped authority, review, and restoration of agency where possible. “Preventing harm” becomes a route to false coherence when vague, unilateral, or unreviewable claims authorize domination or suppress the people said to be protected.
