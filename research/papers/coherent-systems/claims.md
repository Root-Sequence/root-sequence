...
**Editorial states:** PROVISIONAL, CONTESTED, RETIRED, REVIEWED. Every initial entry is PROVISIONAL; a citation alone does not change that state. Retired identifiers remain in the history and are never reused. Split compound claims when their evidence differs.

Bibliographic keys resolve in [references.bib](references.bib). Source coverage is recorded in [the source map](notes/source-map.md). The paper's section numbers refer to [paper.md](paper.md).

## C-001 — Local success is not a systemic guarantee
...
**Related:** sections 1–2; Q-001; public Intelligence Ecology and institutional-ecology map.

## C-002 — Surrounding conditions affect what behavior persists

**Type / state:** HYPOTHESIS informed by systems analysis / PROVISIONAL.  
**Proposition:** Altering permissions, rewards, information, or dependencies can change which behaviors persist, even without changing an actor's nominal goal.

**Basis:** public `concepts/intelligence-ecology.md`; `meadowsLeveragePoints` as conceptual grounding.  
...
**Proposition:** Distinguish functional performance from coherence and normative legitimacy while examining how purposes, boundaries, power, and decision rights shape all three. A process that executes its target but depends on domination, suppressed feedback, hidden externalized costs, excluded affected people, or coercion justified by an unchallengeable harm claim may exhibit false coherence rather than genuine fit.
...
**Objection / boundary:** If every moral objection or coercive intervention is renamed incoherence, the term becomes a circular synonym for disapproval. Coercion describes how meaningful choice is overridden; it does not alone determine whether an intervention is justified. The analysis should identify the mechanism and examine the claimed harm, evidence, affected parties, severity, immediacy, uncertainty, alternatives, scope, duration, authority, review, and prospects for restoring agency. Normative legitimacy still asks questions that a coherence diagnosis cannot answer by itself.

**Evidence needed / revision trigger:** Reviewers should distinguish target execution from genuine coherence in an effective but dominating arrangement, a bounded intervention responding to immediate harm, and a protective but unreliable system. Revise if “false coherence” cannot be tied to a specified mechanism, if the claimed harm cannot be examined or contested, or if the vocabulary adds no explanatory value.
...
**Author-stated direction:** Serious coercion itself makes the apparent coherence incoherent because people, power, and lived consequences belong inside the system boundary. The author recalled the existing term **false coherence** for a system that seems to work but is ultimately flawed and incoherent, and agreed that openly acknowledging the coercion does not make the arrangement coherent. The author compared acknowledgment to admitting a lie: what happens afterward is important. The author then noted that whether an action is understood as stopping harm depends on someone's definition of harm, although it should not rest on one person's unchecked definition.

**Assistant synthesis for review:** Reserve “functional performance” for successful execution of a stated target. Use “false coherence” when apparent order or effectiveness depends on domination, suppressed dissent or feedback, hidden externalized costs, excluded affected people, or coercion authorized by a vague or unchallengeable harm claim. Coercion describes a means rather than deciding the whole moral question; a bounded intervention can override choice to stop immediate harm. Claims of harm cannot be perspective-free, but they should be explicit, evidence-responsive, proportionate to urgency and consequence, open to affected perspectives and challenge, and subject to review even when urgent action limits prior deliberation. Concealment is not required: the falsehood lies in treating controlled stability as coherence. Explicit acknowledgment can make the coercion more legible and the process more revisable without repairing the coerced relationship or restoring agency. What follows determines whether the process begins moving toward greater coherence: ending or reducing the coercion, restoring agency, repairing consequences, accepting accountability, or changing the conditions that reproduce the harm. Treating admission itself as resolution can become another layer of false coherence. This extends an existing project term beyond manufactured consensus; it should remain tied to an identifiable mechanism rather than becoming a label for anything disfavored.
...
**Next question:** When urgent action makes prior agreement impossible, who should be able to define, challenge, and later review the claimed harm and the intervention taken in response?

## C-004 — Explicit disagreement belongs in assessment

**Type / state:** DESIGN PROPOSITION with philosophical grounding / PROVISIONAL.  
**Proposition:** Record contested purposes and unresolved objections rather than treating agreement as a complete test of legitimacy.

**Basis:** `gabriel2020alignment`; public collective-judgment analysis.  
**Support limit:** This does not demonstrate a universally legitimate procedure or make dissent a veto.  
**Objection / boundary:** Recording disagreement may burden participants or expose them to retaliation. Some decisions must occur despite unresolved objections.  
**Evidence needed / revision trigger:** Assess accessibility, privacy, decision quality, and participant burden; revise procedures that create coercion or collect unnecessary personal data.  
**Related:** sections 5 and 9; Q-003 and Q-005.

## C-005 — Proxy failure does not invalidate all optimization
...
**Related:** section 6; Q-004; T-002–T-003.

## C-006 — Conditions and outcomes require separate examination

**Type / state:** DESIGN PROPOSITION + HYPOTHESIS / PROVISIONAL.  
**Proposition:** Assessment should examine both immediate outcomes and the conditions retained for maintenance, correction, participation, and adaptation.

**Basis:** Root Sequence synthesis; not independently validated in this draft.  
**Support limit:** No evidence yet that this particular bundle predicts desirable outcomes.  
...
**Related:** section 7; Q-002 and Q-006.

## C-008 — Architectural labels are not sufficient evidence of agency

**Type / state:** INFERENCE + DESIGN PROPOSITION / PROVISIONAL.  
**Proposition:** Inspect actual decision rights, dependencies, and options rather than inferring agency or legitimacy from centralization or decentralization alone.
...
## C-009 — More capable intelligence may change specific bottlenecks

**Type / state:** HYPOTHESIS / PROVISIONAL.  
**Proposition:** An increase in useful capability may change the feasibility or cost of particular coordination tasks.
...
## C-010 — Scenarios can generate questions without validating answers

**Type / state:** DESIGN PROPOSITION / PROVISIONAL.  
**Proposition:** Use speculative scenarios and recovered possibilities to expose assumptions and generate hypotheses, not as empirical evidence of feasibility.

**Basis:** public `futures/README.md`; the proposed relationship to Coherent World and No One Noticed.  
**Support limit:** No claim that imagination necessarily outperforms prediction or that an abandoned future was technically viable.  
**Objection / boundary:** Compelling stories can reinforce preferred assumptions and overlook real constraints.  
**Evidence needed / revision trigger:** Require contrasting scenarios, an assumption list, and independent evidence for extracted claims. Discard hypotheses contradicted by evidence.  
**Related:** section 10; Q-009; T-001.
...
**Objection / boundary:** Incremental steps can lock in poor arrangements; coordinated discontinuities may sometimes be required.  
