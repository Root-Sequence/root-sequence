...
- [`research/`](research/README.md) — bounded research inquiries and versioned synthesis papers that connect existing work without replacing its canonical sources.
...
- **Research inquiries and papers ↔ every layer** — investigate bounded questions, synthesize arguments, track evidence, and return objections without taking over the source material's canonical home.
