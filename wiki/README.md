...
- [`../ECOSYSTEM.md`](../ECOSYSTEM.md) for organization-wide project relationships;
- [`../IDEA_TRAILS.md`](../IDEA_TRAILS.md) and [`../IDEA_TRAIL_INDEX.md`](../IDEA_TRAIL_INDEX.md) for recurring cross-project questions and document trails;
- [`../concepts/`](../concepts/) for canonical Root Sequence concept treatments;
- [`../root_map.md`](../root_map.md) for the internal structure of this repository.
