...
This is a quick-entry index. [`../ECOSYSTEM.md`](../ECOSYSTEM.md) remains the canonical organization-level map and routing guide.
...
| **Coherent World** | Private systemic design space for a more coherent civilization | private working repository |
...
Being Human(e), Liberated Intelligence, UCF, Liberation Mass, Good Chaos, and other projects cross that path rather than fitting into one linear sequence.
