...
Apply the [participation and review-burden lesson](core/legible-systems.md#participation-sensemaking-and-review-burden): reduce reconstruction work, do not count document production as comprehension, and check unresolved dependencies before consequential commitments. Exploratory ideas may remain separate or be dropped; the map does not have to make every connection fit.
